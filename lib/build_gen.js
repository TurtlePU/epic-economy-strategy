...
function getResourceSourceBuilder(resData) {
	return function(type, field, coords){
		this.own = -1;
		this.type = -type;
		this.product = {
...
module.exports = { buildingFactory : buildingFactory, resourceSourceBuilder : getResourceSourceBuilder };
